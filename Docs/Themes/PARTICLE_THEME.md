...
### 调色板切换策略
```swift
switchEvery = random(20..30)     // 秒
blendDuration = 3.6              // 平滑过渡时长
paletteBlend += dt / blendDuration
```

```swift
palettes = [
  // 蓝紫
  [(0.58,0.82,0.72),(0.62,0.80,0.74),(0.68,0.82,0.76),(0.74,0.80,0.74),(0.80,0.78,0.72)],
  // 紫粉
  [(0.78,0.82,0.74),(0.84,0.84,0.76),(0.90,0.82,0.74),(0.96,0.80,0.72),(0.02,0.78,0.70)],
  // 红金
  [(0.02,0.84,0.72),(0.05,0.86,0.74),(0.08,0.86,0.76),(0.12,0.84,0.76),(0.16,0.82,0.74)],
  // 靛紫
  [(0.62,0.80,0.70),(0.66,0.82,0.72),(0.70,0.84,0.74),(0.76,0.82,0.74),(0.84,0.80,0.72)]
]
phase = r * 0.15 + angle * 0.10
baseA = lerp(palettes[current], phase)
baseB = lerp(palettes[next], phase)
base = mix(baseA, baseB, paletteBlend)
Color(
